...
def transition_model(corpus, page, damping_factor):
    ...
    unlined_page_probability = (1 - damping_factor) * (1 / num_of_pages)
    linked_page_probability = (damping_factor * (1 / num_of_links_from_page)) + unlined_page_probability

    for key in corpus:
        if key not in corpus[page]:
            result_dict[key] = unlined_page_probability
        else:
            result_dict[key] = linked_page_probability
