...
class MinesweeperAI():
    ...
    def make_random_move(self):
        ...
        for h in range(self.height):
            for w in range(self.width):
                cells.add((h, w))
        cells = cells - self.moves_made - self.mines
    ...
    def get_neighbors(self, cell):
        ...
        for i in [-1, 0, 1]:
            if self.is_valid_height(cell[0] - 1) and self.is_valid_width(cell[1] + i):
                    neighbors.add((cell[0] - 1, cell[1] + i))
            
            if self.is_valid_height(cell[0] + 1) and self.is_valid_width(cell[1] + i):
                    neighbors.add((cell[0] + 1, cell[1] + i))
            
            if i != 0 and self.is_valid_width(cell[1] + i):
                neighbors.add((cell[0], cell[1] + i))
        return neighbors
